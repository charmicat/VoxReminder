...
public class HelperFunctions {
    ...
    public static void runTimedObject(final int interval, final TimedObject t){
        t.execute(); // first check, next at [interval] seconds

        CountDownTimer minutesTimer = new CountDownTimer(interval, interval) {
